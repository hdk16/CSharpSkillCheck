...
namespace ProblemThree_CompleteSolution
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("The total cost for {0} packets of {1} is {2}/- INR", quantityToBuy,gosObj.getV2(),gosObj.PayPerPiece(quantityToBuy));
            Console.WriteLine("The total cost for {0} grams of {1} is {2}/- INR", quantityInGrams, gosTwoObj.getV2(), gosTwoObj.PayPerPiece(quantityToBuy));
            ...
            Console.WriteLine("The total cost for {0} packets of {1} is {2}/- INR", quantityToBuyCoffee, coffObj.getV2(), coffObj.PayPerPiece(quantityToBuy));
            Console.WriteLine("The total cost for {0} grams of {1} is {2}/- INR", quantityInGramsCoffee, coffTwoObj.getV2(), coffTwoObj.PayPerPiece(quantityToBuy));
